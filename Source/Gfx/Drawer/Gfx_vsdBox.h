...
public:
    ...
    static VsData<V> MakeData_Model()
    {
        ...
        aData[0].m_uv  = { 0.0f, 1.0f };
        aData[1].m_uv  = { 1.0f, 1.0f };
        aData[2].m_uv  = { 0.0f, 0.0f };
        aData[3].m_uv  = { 1.0f, 0.0f };                //near
        aData[4].m_uv  = { 0.0f, 1.0f };
        aData[5].m_uv  = { 1.0f, 1.0f };
        aData[6].m_uv  = { 0.0f, 0.0f };
        aData[7].m_uv  = { 1.0f, 0.0f };                //far
        aData[8].m_uv  = { 0.0f, 1.0f };
        aData[9].m_uv  = { 1.0f, 1.0f };
        aData[10].m_uv = { 0.0f, 0.0f };
        aData[11].m_uv = { 1.0f, 0.0f };                //left
        aData[12].m_uv = { 0.0f, 1.0f };
        aData[13].m_uv = { 1.0f, 1.0f };
        aData[14].m_uv = { 0.0f, 0.0f };
        aData[15].m_uv = { 1.0f, 0.0f };                //right
        aData[16].m_uv = { 0.0f, 1.0f };
        aData[17].m_uv = { 1.0f, 1.0f };
        aData[18].m_uv = { 0.0f, 0.0f };
        aData[19].m_uv = { 1.0f, 0.0f };                //bottom
        aData[20].m_uv = { 0.0f, 1.0f };
        aData[21].m_uv = { 1.0f, 1.0f };
        aData[22].m_uv = { 0.0f, 0.0f };
        aData[23].m_uv = { 1.0f, 0.0f };                //top
